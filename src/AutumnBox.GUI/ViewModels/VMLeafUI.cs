...
using AutumnBox.GUI.Views.SubWindowViews;
...
namespace AutumnBox.GUI.ViewModels
{
    class VMLeafUI : ViewModelBase, ILeafUI
    {
        ...
        public void ShowMessage(string message)
        {
            ...
            App.Current.Dispatcher.Invoke(() =>
            {
                var view = new LeafUIMessageView(message);
                task = subWindowDialogManager.ShowDialog(Token, new LeafUIMessageView(message));
            });
            task.Wait();
        }
        ...
        public bool? DoChoice(string message, string btnYes = null, string btnNo = null, string btnCancel = null)
        {
            ...
            App.Current.Dispatcher.Invoke(() =>
            {
                var view = new LeafUIChoiceView(message, btnYes, btnNo, btnCancel);
        ...
        public object SelectOne(string hint, params object[] options)
        {
            ...
            App.Current.Dispatcher.Invoke(() =>
            {
                var view = new LeafUISingleSelectView(hint, options);
                task = subWindowDialogManager.ShowDialog(Token, view);
            });
            task.Wait();
            return task.Result;
        ...
        public bool DoYN(string message, string btnYes = null, string btnNo = null)
        {
            ...
            App.Current.Dispatcher.Invoke(() =>
            {
                var view = new LeafUIYNView(message, btnYes, btnNo);
                task = subWindowDialogManager.ShowDialog(Token, view);
            });
            task.Wait();
        ...
        public string InputString(string hint = null, string _default = null)
        {
            ...
            App.Current.Dispatcher.Invoke(() =>
            {
                var view = new LeafUIInputView(hint, _default);
                task = subWindowDialogManager.ShowDialog(Token, view);
            });
            task.Wait();
